...
aplicacion.title('Restaurante - Facturación')
aplicacion.config(bg = 'gray30')
...
def recibo():
    ...
    texto_recibo.insert(END, f'Precio postres: \t\t\t{var_costo_postre.get()}\n')
    texto_recibo.insert(END, f'-' * 54 + '\n')
    texto_recibo.insert(END, f'Subtotal: \t\t\t{var_subtotal.get()}\n')
    texto_recibo.insert(END, f'Impuestos: \t\t\t{var_impuestos.get()}\n')
    texto_recibo.insert(END, f'Total: \t\t\t{var_total.get()}\n')
    texto_recibo.insert(END, f'*' * 47 + '\n')
    texto_recibo.insert(END, 'Gracias pos su visita')
...
etiqueta_titulo = Label(panel_superior, text='Sistema de facturación', fg='azure4', font=('Dosis', 58), bg='gray100', width=27)
...
lista_comidas = ['ternera', 'cerdo', 'pollo', 'burguer', 'churrasco', 'popetas', 'patatas', 'chocos']
lista_bebidas = ['coca-cola', 'agua', 'red bull', 'fanta', 'birrias', 'vino malo', 'zumako', 'infusiones']
lista_postres = ['helado', 'tiramisu', 'flan', 'tarta queso', 'filloas', 'fruta', 'yogurt', 'natillas']
...
for bebida in lista_bebidas:
    ...
    bebida = Checkbutton(panel_bebidas, text=bebida.title(), font=('Dosis', 19, 'bold'), onvalue=1, offvalue=0, variable=variables_bebida[contador], command=revisar_check)
...
for postre in lista_postres:
    ...
    postre = Checkbutton(panel_postres, text=postre.title(), font=('Dosis', 19, 'bold'), onvalue=1, offvalue=0, variable=variables_postre[contador], command=revisar_check)
...
etiqueta_costo_comida = Label(panel_costos, text='Precio Comida', font=('Dosis', 12, 'bold'), bg='azure4', fg='white')
...
etiqueta_costo_bebida = Label(panel_costos, text='Precio Bebida', font=('Dosis', 12, 'bold'), bg='azure4', fg='white')
...
etiqueta_costo_postre = Label(panel_costos, text='Precio Postre', font=('Dosis', 12, 'bold'), bg='azure4', fg='white')
